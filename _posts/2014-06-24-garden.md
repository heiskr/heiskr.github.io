...
*Alias: Destructuring.* `With ... of ...` statements already provide a most basic destructuring. This alias will turn on destructuring across the board.
...
*Alias: Type Annotation.* With this alias enabled, function arguments and returns can have a type specified. Type annotations are checked at build-type and not run-time.
    ...
    set my_add to do num1:number to num2:number
